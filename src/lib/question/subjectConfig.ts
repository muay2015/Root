...
export const SUBJECT_CONFIG: Record<SubjectKey, SubjectConfig> = {
  ...
  middle_english: { label: '중등 영어', category: 'english', selectorMode: 'format', formats: ['객관식', '단답형'], defaultFormat: '객관식', exampleTopic: '예: 현재완료 시제의 이해, 중학교 필수 교과서 대화문', csatExampleTopic: '예: 중등 영어 내신 고득점 대비 필수 구문', supportedLevels: ['middle'], supportedGrades: ['1학년', '2학년', '3학년'], uploadRecommendation: 'REQUIRED' },
  ...
  high_english: { label: '고등 영어', category: 'english', selectorMode: 'format', formats: ['객관식', '단답형'], defaultFormat: '객관식', exampleTopic: '예: 관계대명사와 분사구문, 고교 필수 단어와 숙어', csatExampleTopic: '예: 모의고사 변형 문제 및 수능 대비 기초 독해', supportedLevels: ['high'], supportedGrades: ['1학년'], uploadRecommendation: 'REQUIRED' },
