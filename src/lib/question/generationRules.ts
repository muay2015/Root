...
const subjectRules: Record<SubjectKey, SubjectRule> = {
  english: {
  ...
  korean_history: {
    ...
    stemGuidance: [
      ...
      'If the user provides only a unit name (e.g., "삼국 시대" or "조선 후기"), use your internal knowledge of the standard national curriculum to derive key historical facts and concept linkages automatically.',
