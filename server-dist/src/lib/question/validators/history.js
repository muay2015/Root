import { pushReason, normalizeText, countWords } from "./utils.js";
/**
 * 한국사 과목의 난이도 규칙을 검증합니다.
 */
export function validateHistoryDifficulty(question, index, difficulty, reasons, warnings, issueCounts) {
    if (difficulty !== 'hard') {
 ...
 */
export function validateHistorySubjectFit(question, index, reasons, warnings, issueCounts) {
