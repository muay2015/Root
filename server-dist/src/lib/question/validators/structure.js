import { countAnswerMatches, resolveAnswerFromChoices, normalizeAnswerComparison } from "../answerMatching.js";
import { pushReason, normalizeText, parseAnswerChoiceIndex } from "./utils.js";
/**
 * 문항의 기본적인 구조(선지 수, 비어있는 필드, 정답 부합 여부 등)를 검증합니다.
 */
export function validateStructure(question, index, reasons, issueCounts) {
