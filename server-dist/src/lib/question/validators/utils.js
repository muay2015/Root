import { normalizeAnswerComparison } from "../answerMatching.js";
/**
 * 에러 사유를 기록하고 이슈 카운트를 증가시킵니다.
 */
export function pushReason(reasons, issueCounts, key, message) {
 ...
 * 한글 문자 수를 계산합니다.
 */
export function countKoreanCharacters(value) {
 ...
 */
export function parseLetterChoiceIndex(value) {
