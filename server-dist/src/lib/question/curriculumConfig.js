...
export const MIDDLE_KOREAN_CURRICULUM = [
...
export const MIDDLE_ENGLISH_CURRICULUM = [
...
export const MIDDLE_SOCIAL_CURRICULUM = [
...
export const MIDDLE_HISTORY_CURRICULUM = [
...
export const MIDDLE_SCIENCE_CURRICULUM = [
    {
        grade: '1학년',
        areas: [
...
export const HIGH_CORE_CURRICULUM = {
    high_math: [
        {
            grade: '1학년',
            areas: [
...
export const CURRICULUM_MAP = {
    ...
    ...Object.fromEntries(Object.entries(HIGH_CORE_CURRICULUM).filter(([key]) => !key.includes('korean') && !key.includes('english'))),
    // 사회
