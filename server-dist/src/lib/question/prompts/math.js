...
export function buildMiddleMathPromptRules() {
    return [
        ...
        // ========== 선지(choices) 위치 관계 예외 ==========
        '- [MIDDLE CHOICE RELATION] 위치 관계를 묻는 문항(원과 직선, 두 원의 위치 관계 등)에서는 선지를 위치 관계 서술문으로 구성하십시오.',
        '  예: ["직선 l과 원 O는 한 점에서 만난다.", "직선 l과 원 O는 두 점에서 만난다.", "직선 l과 원 O는 만나지 않는다.", "직선 l은 원 O의 내부를 지난다.", "직선 l은 원 O의 중심을 지난다."]',
        '  이 경우 선지 형식은 모두 서술문으로 통일하고, 길이도 최대한 맞추십시오.',
        // ========== 그림 참조 일관성 ==========
        ...
        '- [MIDDLE DIAGRAM] 기본값은 diagram_svg=null입니다. 도형의 위치 관계 파악이 필수인 경우에는 반드시 SVG를 생성하십시오.',
        ...
        // ========== 원과 직선 유형 전용 필수 규칙 ==========
        '- [CIRCLE-LINE MANDATORY] 「원과 직선」 유형은 아래 규칙을 모두 준수하십시오.',
        '',
        '  [발문 형식]',
        '  stem은 반드시 "직선 l과 원 O의 위치 관계로 옳은 것은?" 형식의 교과서/시험형 문체로 작성하십시오.',
        '  "직선 l의 위치를 올바르게 판단한 것은?" 같은 어색한 문체는 사용하지 마십시오.',
        '',
        '  [stimulus 형식]',
        '  "원 O의 반지름의 길이: r cm\\n중심 O에서 직선 l까지의 거리: d cm" 형태로 간결하게 제시하십시오.',
        '',
        '  [선지 형식] 반드시 아래 5개 선지 구조를 따르십시오:',
        '  "직선 l과 원 O는 한 점에서 만난다."',
        '  "직선 l과 원 O는 두 점에서 만난다."',
        '  "직선 l과 원 O는 만나지 않는다."',
        '  "직선 l은 원 O의 내부를 지난다."',
        '  "직선 l은 원 O의 중심을 지난다."',
        '',
        ...
        '',
        '  [diagram_svg 필수 규칙]',
        '  원과 직선 문항은 diagram_svg를 반드시 생성하십시오. null이면 즉시 폐기.',
        '  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        '  ⚠ 경고: 조건과 그림이 불일치하면 수정 실패로 간주합니다.',
        '  • d = r → 직선이 원에 접해야 함. 직선이 원을 관통하는 할선으로 그리면 오류.',
        '  • d < r → 직선이 원을 두 점에서 가로질러야 함.',
        '  • d > r → 직선이 원과 완전히 떨어져 있어야 함.',
        '  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━',
        '',
        '  [SVG 필수 포함 요소]',
        '  1. 원 + 중심점 O (레이블 포함)',
        '  2. 직선 l (조건에 맞는 위치, 레이블 포함)',
        '  3. O에서 직선 l에 내린 수선 (파선, stroke-dasharray="5,3")',
        '  4. 수선의 발(접점)에 직각 기호 (L자 모양 path)',
        '  5. 수선 위에 거리 수치 직접 표시 (예: "6 cm") ← 없으면 오류',
        '  6. O, l 레이블이 서로 겹치지 않을 것',
        '',
        '  [SVG 템플릿 — d = r (접선)] 수치는 실제 값으로 교체:',
        '  diagram_svg="<svg viewBox=\\"0 0 360 300\\" width=\\"100%\\" style=\\"max-width:360px;display:block\\">',
        ...
        '  <text x=\\"192\\" y=\\"143\\" font-size=\\"12\\" text-anchor=\\"middle\\" font-family=\\"sans-serif\\">6 cm</text>',
        '  </svg>"',
        '  → "6 cm" 부분을 문제 조건의 실제 수치로 교체하십시오.',
        '',
        '  [SVG 템플릿 — d < r (할선)] 직선이 원을 두 점에서 가로지름:',
        '  diagram_svg="<svg viewBox=\\"0 0 360 300\\" width=\\"100%\\" style=\\"max-width:360px;display:block\\">',
        '  <circle cx=\\"150\\" cy=\\"150\\" r=\\"90\\" fill=\\"none\\" stroke=\\"#222\\" stroke-width=\\"1.8\\"/>',
        '  <line x1=\\"210\\" y1=\\"18\\" x2=\\"210\\" y2=\\"282\\" stroke=\\"#222\\" stroke-width=\\"1.8\\"/>',
        '  <line x1=\\"150\\" y1=\\"150\\" x2=\\"210\\" y2=\\"150\\" stroke=\\"#555\\" stroke-width=\\"1.3\\" stroke-dasharray=\\"5,3\\"/>',
        '  <circle cx=\\"150\\" cy=\\"150\\" r=\\"3.5\\" fill=\\"#222\\"/>',
        '  <path d=\\"M210,140 L200,140 L200,150\\" fill=\\"none\\" stroke=\\"#222\\" stroke-width=\\"1.3\\"/>',
        '  <text x=\\"134\\" y=\\"143\\" font-size=\\"15\\" font-family=\\"serif\\">O</text>',
        '  <text x=\\"216\\" y=\\"30\\" font-size=\\"15\\" font-family=\\"serif\\" font-style=\\"italic\\">l</text>',
        '  <text x=\\"177\\" y=\\"143\\" font-size=\\"12\\" text-anchor=\\"middle\\" font-family=\\"sans-serif\\">d cm</text>',
        '  </svg>"',
        '',
        '  [SVG 템플릿 — d > r (외부)] 직선과 원이 만나지 않음:',
        '  diagram_svg="<svg viewBox=\\"0 0 360 300\\" width=\\"100%\\" style=\\"max-width:360px;display:block\\">',
        '  <circle cx=\\"140\\" cy=\\"150\\" r=\\"80\\" fill=\\"none\\" stroke=\\"#222\\" stroke-width=\\"1.8\\"/>',
        '  <line x1=\\"270\\" y1=\\"18\\" x2=\\"270\\" y2=\\"282\\" stroke=\\"#222\\" stroke-width=\\"1.8\\"/>',
        '  <line x1=\\"140\\" y1=\\"150\\" x2=\\"270\\" y2=\\"150\\" stroke=\\"#555\\" stroke-width=\\"1.3\\" stroke-dasharray=\\"5,3\\"/>',
        '  <circle cx=\\"140\\" cy=\\"150\\" r=\\"3.5\\" fill=\\"#222\\"/>',
        '  <path d=\\"M270,140 L260,140 L260,150\\" fill=\\"none\\" stroke=\\"#222\\" stroke-width=\\"1.3\\"/>',
        '  <text x=\\"124\\" y=\\"143\\" font-size=\\"15\\" font-family=\\"serif\\">O</text>',
        '  <text x=\\"276\\" y=\\"30\\" font-size=\\"15\\" font-family=\\"serif\\" font-style=\\"italic\\">l</text>',
        '  <text x=\\"202\\" y=\\"143\\" font-size=\\"12\\" text-anchor=\\"middle\\" font-family=\\"sans-serif\\">d cm</text>',
        '  </svg>"',
    ];
}
/**
...
export function buildCsatMathPrompt(input) {
    ...
    return [
        ...
        '',
        '--- 예시 1: 순수 대수 문항 (diagram_svg=null) ---',
        '```',
        '[',
        '  {',
        '    "topic": "수열",',
        ...
        '    "answer": "26",',
        '    "explanation": "a_1 + a_{10} = a_3 + a_7 = 26",',
        '    "diagram_svg": null',
        '  }',
        ']',
        '```',
        '',
        '--- 예시 2: 원 기하 문항 (diagram_svg 필수) ---',
        '원·삼각형·각도가 포함된 기하 문항은 반드시 아래와 같이 diagram_svg에 SVG를 생성하십시오.',
        '```',
        '[',
        '  {',
        '    "topic": "원의 성질",',
        '    "type": "multiple",',
        '    "stem": "그림과 같이 원 위의 네 점 A, B, C, D에서 두 현 AC, BD가 원 안의 점 P에서 만날 때, ∠APB의 크기는?",',
        '    "stimulus": "∠ABD = 35°\\n∠CAB = 50°",',
        '    "choices": ["75°", "80°", "85°", "90°", "95°"],',
        '    "answer": "85°",',
        '    "explanation": "원주각의 성질에 의해 ∠APB = ∠ABD + ∠CAB = 35 + 50 = 85°",',
        '    "diagram_svg": "<svg viewBox=\\"0 0 360 310\\" width=\\"100%\\" style=\\"max-width:360px;display:block\\"><circle cx=\\"180\\" cy=\\"155\\" r=\\"110\\" fill=\\"none\\" stroke=\\"#222\\" stroke-width=\\"1.5\\"/><line x1=\\"102\\" y1=\\"77\\" x2=\\"258\\" y2=\\"233\\" stroke=\\"#222\\" stroke-width=\\"1.5\\"/><line x1=\\"258\\" y1=\\"77\\" x2=\\"102\\" y2=\\"233\\" stroke=\\"#222\\" stroke-width=\\"1.5\\"/><circle cx=\\"102\\" cy=\\"77\\" r=\\"3\\" fill=\\"#222\\"/><text x=\\"88\\" y=\\"70\\" font-size=\\"13\\">A</text><circle cx=\\"258\\" cy=\\"233\\" r=\\"3\\" fill=\\"#222\\"/><text x=\\"263\\" y=\\"240\\" font-size=\\"13\\">C</text><circle cx=\\"258\\" cy=\\"77\\" r=\\"3\\" fill=\\"#222\\"/><text x=\\"263\\" y=\\"70\\" font-size=\\"13\\">B</text><circle cx=\\"102\\" cy=\\"233\\" r=\\"3\\" fill=\\"#222\\"/><text x=\\"85\\" y=\\"245\\" font-size=\\"13\\">D</text><circle cx=\\"180\\" cy=\\"155\\" r=\\"3\\" fill=\\"#222\\"/><text x=\\"186\\" y=\\"150\\" font-size=\\"13\\">P</text></svg>"',
        '  }',
        ']',
        '```',
        '',
