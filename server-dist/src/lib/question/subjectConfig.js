...
export const SUBJECT_CONFIG = {
    middle_korean: { label: '중등국어', category: 'korean', selectorMode: 'format', formats: ['객관식', '단답형'], defaultFormat: '객관식', exampleTopic: '예: 품사의 종류와 특성, 시의 정서와 분위기', csatExampleTopic: '예: 중학 국어 성취도 평가 대비 전 범위', supportedLevels: ['middle'], supportedGrades: ['1학년', '2학년', '3학년'], uploadRecommendation: 'REQUIRED' },
    middle_math: { label: '중등수학', category: 'math', selectorMode: 'questionType', questionTypes: ['전체', '수와 연산', '문자와 식', '함수', '기하(도형)', '확률과 통계'], defaultQuestionType: '전체', exampleTopic: '예: 소인수분해, 일차방정식, 일차함수, 피타고라스 정리, 확률', csatExampleTopic: '예: 중등 수학 기초 학력 진단 평가 준비', supportedLevels: ['middle'], supportedGrades: ['1학년', '2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    middle_english: { label: '중등영어', category: 'english', selectorMode: 'questionType', questionTypes: ['전체', '요지/주제/제목', '어법/어휘', '빈칸 추론', '문장 삽입', '순서 배열', '심경/분위기', '내용 일치', '관계없는 문장', '요약문 완성'], defaultQuestionType: '전체', exampleTopic: '예: 현재완료 시제의 이해, 중학교 필수 교과서 대화문', csatExampleTopic: '예: 중등 영어 내신 고득점 대비 필수 구문', supportedLevels: ['middle'], supportedGrades: ['1학년', '2학년', '3학년'], uploadRecommendation: 'REQUIRED' },
    ...
    high_math: { label: '고등수학(공통)', category: 'math', selectorMode: 'questionType', questionTypes: ['전체', '다항식', '방정식/부등식', '도형의 방정식', '집합과 명제', '함수', '경우의 수'], defaultQuestionType: '전체', exampleTopic: '예: 집합과 명제, 함수와 그래프, 경우의 수', csatExampleTopic: '예: 고1 수학 전국연합학력평가 기출 유형', supportedLevels: ['high'], supportedGrades: ['1학년'], uploadRecommendation: 'RECOMMENDED' },
    high_english: { label: '고등영어', category: 'english', selectorMode: 'questionType', questionTypes: ['전체', '요지/주제/제목', '어법/어휘', '빈칸 추론', '문장 삽입', '순서 배열', '심경/분위기', '내용 일치', '관계없는 문장', '요약문 완성'], defaultQuestionType: '전체', exampleTopic: '예: 관계대명사와 분사구문, 고교 필수 단어와 숙어', csatExampleTopic: '예: 모의고사 변형 문제 및 수능 대비 기초 독해', supportedLevels: ['high'], supportedGrades: ['1학년', '2학년', '3학년'], uploadRecommendation: 'REQUIRED' },
    high_korean_history: { label: '고등한국사', category: 'history', selectorMode: 'questionType', questionTypes: ['전체', '전근대사', '근대사', '현대사'], defaultQuestionType: '전체', exampleTopic: '예: 전근대 한국사의 이해, 근현대사의 전개', csatExampleTopic: '예: 수능 한국사 및 한능검 대비 통합 역사 지식', supportedLevels: ['high'], supportedGrades: ['1학년'], uploadRecommendation: 'OPTIONAL' },
    high_social: { label: '고등통합사회', category: 'social', selectorMode: 'questionType', questionTypes: ['전체', '인권과 정의', '문화와 변동', '시장과 경제', '환경과 지속가능성'], defaultQuestionType: '전체', exampleTopic: '예: 삶의 목적으로서의 행복, 문화 다양성과 존중', csatExampleTopic: '예: 고1 통합사회 전국모의고사 핵심 기출', supportedLevels: ['high'], supportedGrades: ['1학년'], uploadRecommendation: 'RECOMMENDED' },
    high_science: { label: '고등통합과학', category: 'science', selectorMode: 'questionType', questionTypes: ['전체', '물질의 규칙성', '시스템과 상호작용', '변화와 다양성', '환경과 에너지'], defaultQuestionType: '전체', exampleTopic: '예: 물질의 규칙성과 결합, 생태계와 환경', csatExampleTopic: '예: 고1 통합과학 탐구 실험 및 핵심 이론', supportedLevels: ['high'], supportedGrades: ['1학년'], uploadRecommendation: 'RECOMMENDED' },
    // --- 고등 선택/수능 과목 (유지) ---
    korean_writing: { label: '화법과작문', category: 'korean', selectorMode: 'format', formats: ['객관식', '단답형'], defaultFormat: '객관식', exampleTopic: '예: 토론에서의 반론 전략, 설득하는 글쓰기', csatExampleTopic: '예: 수능 화법과 작문 실전 모의고사 전 범위', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'REQUIRED' },
    korean_media: { label: '언어와매체', category: 'korean', selectorMode: 'format', formats: ['객관식', '단답형'], defaultFormat: '객관식', exampleTopic: '예: 형태소의 분석, 매체 자료의 비판적 수용', csatExampleTopic: '예: 킬러 문항 대비 국어 문법/언어와 매체 전 범위', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'REQUIRED' },
    ...
    math_1: { label: '수학I', category: 'math', selectorMode: 'questionType', questionTypes: ['전체', '지수/로그', '삼각함수', '수열'], defaultQuestionType: '전체', exampleTopic: '예: 로그함수의 성질, 등차수열과 등비수열', csatExampleTopic: '예: 사인법칙과 코사인법칙의 활용, 수열의 추론', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    math_2: { label: '수학II', category: 'math', selectorMode: 'questionType', questionTypes: ['전체', '함수의 극한', '미분', '적분'], defaultQuestionType: '전체', exampleTopic: '예: 함수의 연속성, 정적분의 활용', csatExampleTopic: '예: 함수의 극대/극소와 그래프 추론 킬러 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'OPTIONAL' },
    math_calculus: { label: '수학(미적분)', category: 'math', selectorMode: 'questionType', questionTypes: ['전체', '수열의 극한', '미분법', '적분법'], defaultQuestionType: '전체', exampleTopic: '예: 초월함수의 미분, 치환적분과 부분적분', csatExampleTopic: '예: 수능 30번 스타일 미적분 고난도 응용 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'OPTIONAL' },
    math_stats: { label: '수학(확률과통계)', category: 'math', selectorMode: 'questionType', questionTypes: ['전체', '순열/조합', '확률', '통계'], defaultQuestionType: '전체', exampleTopic: '예: 조건부 확률, 정규분포의 성질', csatExampleTopic: '예: 여러 가지 순열과 조합, 통계적 추정', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'OPTIONAL' },
    math_geometry: { label: '수학(기하)', category: 'math', selectorMode: 'questionType', questionTypes: ['전체', '이차곡선', '평면벡터', '공간도형/좌표'], defaultQuestionType: '전체', exampleTopic: '예: 타원의 방정식, 벡터의 내적 활용', csatExampleTopic: '예: 공간도형에서의 정사영과 이면각 킬러 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    ...
    living_ethics: { label: '생활과윤리', category: 'social', selectorMode: 'questionType', questionTypes: ['전체', '윤리학의 종류', '생명/환경 윤리', '사회/문화 윤리', '평화 윤리'], defaultQuestionType: '전체', exampleTopic: '예: 인간과 환경의 윤리, 정의로운 사회', csatExampleTopic: '예: 환경 윤리와 사회 정의 사상가 비교(싱어/레건/롤스)', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'OPTIONAL' },
    ...
    politics_law: { label: '정치와법', category: 'social', selectorMode: 'questionType', questionTypes: ['전체', '민주주의와 법', '개인 생활과 법', '정치 과정과 참여'], defaultQuestionType: '전체', exampleTopic: '예: 민주 정치의 발전, 헌법과 기본권의 보장', csatExampleTopic: '예: 선거제도 분석 및 형사 절차/상속법 사례 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    ethics_thought: { label: '윤리와사상', category: 'social', selectorMode: 'questionType', questionTypes: ['전체', '동양과 한국 윤리', '서양 윤리', '사회 사상'], defaultQuestionType: '전체', exampleTopic: '예: 동서양 윤리 사상의 흐름, 현대의 도덕적 쟁점', csatExampleTopic: '예: 동서양 주요 사상가 원문 해석 및 관점 비교', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'OPTIONAL' },
    physics_1: { label: '물리학I', category: 'science', selectorMode: 'questionType', questionTypes: ['전체', '역학과 에너지', '물질과 전자기', '파동과 정보'], defaultQuestionType: '전체', exampleTopic: '예: 뉴턴의 운동 법칙, 특수 상대성 이론', csatExampleTopic: '예: 역학적 에너지 보존과 상대성 이론 고난도 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    chemistry_1: { label: '화학I', category: 'science', selectorMode: 'questionType', questionTypes: ['전체', '화학의 첫걸음', '원자의 구조', '결합과 분자', '역동적인 화학'], defaultQuestionType: '전체', exampleTopic: '예: 화학 결합과 분자의 세계, 산화 환원 반응', csatExampleTopic: '예: 몰 농도 계산 및 중화 반응의 양적 관계 킬러 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    biology_1: { label: '생명과학I', category: 'science', selectorMode: 'questionType', questionTypes: ['전체', '생명 활동', '항상성과 조절', '유전', '생태계와 상호작용'], defaultQuestionType: '전체', exampleTopic: '예: 신경계와 항상성 유지, 유전의 원리', csatExampleTopic: '예: 가계도 분석 및 세포 분열 과정 추론 킬러 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    earth_science_1: { label: '지구과학I', category: 'science', selectorMode: 'questionType', questionTypes: ['전체', '고체 지구', '대기와 해양', '우주'], defaultQuestionType: '전체', exampleTopic: '예: 판 구조론과 대륙 이동, 별의 진화와 태양계', csatExampleTopic: '예: 별의 광도 및 대기/해양 순환 자료 해석 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
    physics_2: { label: '물리학II', category: 'science', selectorMode: 'questionType', questionTypes: ['전체', '역학적 상호작용', '전기장과 자기장', '빛과 물질의 이중성'], defaultQuestionType: '전체', exampleTopic: '예: 전자기 유도, 파동의 중첩과 간섭', csatExampleTopic: '예: 평면상의 포물선 운동 및 전자기장 복합 문항', supportedLevels: ['high'], supportedGrades: ['2학년', '3학년'], uploadRecommendation: 'RECOMMENDED' },
